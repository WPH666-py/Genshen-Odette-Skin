...
$script:wallNames = @('壁纸·其一（立绘）', '壁纸·其二（素绘）', '壁纸·其三（校服）')
$script:voiceFile = Join-Path $PSScriptRoot '素材\语音-元素爆发·其一.wav'
$script:skillText = '元素爆发 · 霜羽圆舞'
$script:voiceLine = '“——请看着我。”'
$script:CARD_W = 320

$script:runKeyPath  = 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Run'
$script:runValueName = 'GenshenOdetteSkin'
...
$script:skillLabel.Effect.Color = [System.Windows.Media.Color]::FromArgb(255, 120, 150, 212)
...
$script:lineLabel.Effect.Color = [System.Windows.Media.Color]::FromArgb(255, 130, 158, 215)
...
$flashBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(242, 230, 238, 255), 0))) | Out-Null
$flashBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(140, 106, 133, 200), 0.45))) | Out-Null
$flashBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 24, 30, 70), 1))) | Out-Null
...
$bloomBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(242, 240, 246, 255), 0))) | Out-Null
$bloomBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(191, 133, 158, 216), 0.26))) | Out-Null
$bloomBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(102, 70, 88, 150), 0.5))) | Out-Null
$bloomBrush.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 70, 88, 150), 0.72))) | Out-Null
...
for ($i = 0; $i -lt 3; $i++) {
  ...
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 230, 238, 255), 0))) | Out-Null
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(242, 230, 238, 255), 0.3))) | Out-Null
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(235, 106, 133, 200), 0.6))) | Out-Null
  $slashBrush2.GradientStops.Add((New-Object System.Windows.Media.GradientStop([System.Windows.Media.Color]::FromArgb(0, 106, 133, 200), 1))) | Out-Null
...
for ($i = 0; $i -lt 18; $i++) {
  ...
  $p.Effect.Color = [System.Windows.Media.Color]::FromArgb(255, 130, 158, 215)
  $p.Opacity = 0
...
for ($i = 0; $i -lt 10; $i++) {
  ...
  $st.Effect.Color = [System.Windows.Media.Color]::FromArgb(255, 170, 205, 250)
  $st.Opacity = 0
...
function Invoke-Uninstall {
  ...
  $res = [System.Windows.MessageBox]::Show(
    ('确定卸载奥黛塔桌面皮肤吗？' + [char]10 + '将关闭程序、移除开机自启，并删除本桌面版文件夹。'),
    '奥黛塔皮肤 · 一键卸载',
...
function Show-Menu([string]$mode, [double]$x, [double]$y) {
  ...
  Add-MenuButton '释放元素爆发「霜羽圆舞」' $false { Invoke-Burst } | Out-Null
  Add-MenuLabel '切换壁纸'
